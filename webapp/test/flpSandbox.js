		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Read Data from XL File",
									"targetURL": "#comappreaddatafromxlfile-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappreaddatafromxlfile-display": {
								"semanticObject": "comappreaddatafromxlfile",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.readdatafromxlfile",
									"url": sap.ui.require.toUrl("com/app/readdatafromxlfile")
								}
							}
						}
					}
